...
- [Advanced Walkthrough for C# Developers](#advanced-walkthrough-for-c-developers)
  - [1. Python project setup with uv](#1-python-project-setup-with-uv)
  - [2. Python execution model](#2-python-execution-model)
  - [3. Variables, names, references, and mutability](#3-variables-names-references-and-mutability)
  - [4. Primitive types](#4-primitive-types)
  - [5. Collections: list, tuple, dict, set, frozenset](#5-collections-list-tuple-dict-set-frozenset)
  - [6. Slicing and unpacking](#6-slicing-and-unpacking)
  - [7. Control flow](#7-control-flow)
  - [8. Functions and Parameters](#8-functions-and-parameters)
  - [9. Default arguments and keyword-only arguments](#9-default-arguments-and-keyword-only-arguments)
  ...
  - [18. Imports and import system](#18-imports-and-import-system)
  - [19. Object-oriented programming](#19-object-oriented-programming)
  - [20. Inheritance and composition](#20-inheritance-and-composition)
  - [21. Properties](#21-properties)
  - [22. Dataclasses](#22-dataclasses)
  - [23. Enums](#23-enums)
  - [24. Protocols and structural typing](#24-protocols-and-structural-typing)
  ...
  - [29. Dunder methods and Python data model](#29-dunder-methods-and-python-data-model)
  - [30. Descriptors](#30-descriptors)
  - [31. Metaclasses](#31-metaclasses)
  - [32. Async and await](#32-async-and-await)
  - [33. asyncio tasks, queues, cancellation, timeouts](#33-asyncio-tasks-queues-cancellation-timeouts)
  - [34. Threading](#34-threading)
  - [35. Multiprocessing](#35-multiprocessing)
  - [36. File I/O](#36-file-io)
  - [37. pathlib](#37-pathlib)
  - [38. JSON, CSV, TOML](#38-json-csv-toml)
  - [39. Logging](#39-logging)
  - [40. Testing with pytest](#40-testing-with-pytest)
  - [41. Mocking](#41-mocking)
  - [42. Debugging](#42-debugging)
  - [43. Packaging](#43-packaging)
  - [44. Dependency management](#44-dependency-management)
  - [45. Virtual environments](#45-virtual-environments)
  - [46. Linters and formatters](#46-linters-and-formatters)
  - [47. Performance and profiling](#47-performance-and-profiling)
  - [48. Memory management and garbage collection](#48-memory-management-and-garbage-collection)
  - [49. Standard library overview](#49-standard-library-overview)
  - [50. Python 3.14-specific features](#50-python-314-specific-features)
  - [51. Python idioms versus C# idioms](#51-python-idioms-versus-c-idioms)
  - [52. Common C# to Python migration mistakes](#52-common-c-to-python-migration-mistakes)
  - [53. Async iteration, async generators, and async context managers](#53-async-iteration-async-generators-and-async-context-managers)
  - [54. Exception groups and `except*`](#54-exception-groups-and-except)
  - [55. Assignment expressions (`:=`)](#55-assignment-expressions)
  - [56. Binary data: `bytes`, `bytearray`, and `memoryview`](#56-binary-data-bytes-bytearray-and-memoryview)
  - [57. Advanced typing: `ParamSpec`, `TypeVarTuple`, `Literal`, `Annotated`, `Self`](#57-advanced-typing-paramspec-typevartuple-literal-annotated-self)
  - [58. `__slots__` as a language feature](#58-__slots__-as-a-language-feature)
  - [59. Import hooks: custom finders and loaders](#59-import-hooks-custom-finders-and-loaders)
  - [60. `contextvars` and task-local state](#60-contextvars-and-task-local-state)
  - [61. Weak references and finalization patterns](#61-weak-references-and-finalization-patterns)
  - [62. Advanced descriptor and metaclass patterns](#62-advanced-descriptor-and-metaclass-patterns)

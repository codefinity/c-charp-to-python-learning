...
- [22. Dataclasses](05_oop_and_modeling/22_dataclasses.md)
...
- [35. Multiprocessing](08_concurrency_and_systems/35_multiprocessing.md)
- [36. File I/O](08_concurrency_and_systems/36_file_i_o.md)
- [37. pathlib](08_concurrency_and_systems/37_pathlib.md)
...
- [43. Packaging](09_quality_and_tooling/43_packaging.md)
- [44. Dependency management](09_quality_and_tooling/44_dependency_management.md)
- [45. Virtual environments](09_quality_and_tooling/45_virtual_environments.md)
...
- [56. Binary data: `bytes`, `bytearray`, and `memoryview`](11_additional_language_features/56_binary_data_bytes_bytearray_and_memoryview.md)
- [57. Advanced typing: `ParamSpec`, `TypeVarTuple`, `Literal`, `Annotated`, `Self`](11_additional_language_features/57_advanced_typing_paramspec_typevartuple_literal_annotated_self.md)
- [58. `__slots__` as a language feature](11_additional_language_features/58_slots_as_a_language_feature.md)
- [59. Import hooks: custom finders and loaders](11_additional_language_features/59_import_hooks_custom_finders_and_loaders.md)
- [60. `contextvars` and task-local state](11_additional_language_features/60_contextvars_and_task_local_state.md)
- [61. Weak references and finalization patterns](11_additional_language_features/61_weak_references_and_finalization_patterns.md)
- [62. Advanced descriptor and metaclass patterns](11_additional_language_features/62_advanced_descriptor_and_metaclass_patterns.md)
